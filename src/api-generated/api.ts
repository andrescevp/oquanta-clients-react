...
/**
 * UsersAPIKeysApi - axios parameter creator
 * @export
 */
export const UsersAPIKeysApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Revoke an API key for a specific user.
         * @param {string} userUuid 
         * @param {string} uuid 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteAdminUserApikeysRevoke: async (userUuid: string, uuid: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userUuid' is not null or undefined
            assertParamExists('deleteAdminUserApikeysRevoke', 'userUuid', userUuid)
            // verify required parameter 'uuid' is not null or undefined
            assertParamExists('deleteAdminUserApikeysRevoke', 'uuid', uuid)
            const localVarPath = `/admin/api/users/{userUuid}/apikeys/{uuid}`
        ...
        /**
         * 
         * @summary Get all API keys for a specific user.
         * @param {string} userUuid 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAdminUserApikeysList: async (userUuid: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userUuid' is not null or undefined
            assertParamExists('getAdminUserApikeysList', 'userUuid', userUuid)
            const localVarPath = `/admin/api/users/{userUuid}/apikeys`
                .replace(`{${"userUuid"}}`, encodeURIComponent(String(userUuid)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        /**
         * 
         * @summary Create a new API key for a specific user.
         * @param {string} userUuid 
         * @param {ApiKeyCreate} apiKeyCreate 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        postAdminUserApikeysCreate: async (userUuid: string, apiKeyCreate: ApiKeyCreate, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userUuid' is not null or undefined
            assertParamExists('postAdminUserApikeysCreate', 'userUuid', userUuid)
            // verify required parameter 'apiKeyCreate' is not null or undefined
            assertParamExists('postAdminUserApikeysCreate', 'apiKeyCreate', apiKeyCreate)
            const localVarPath = `/admin/api/users/{userUuid}/apikeys`
                .replace(`{${"userUuid"}}`, encodeURIComponent(String(userUuid)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
/**
 * UsersAPIKeysApi - functional programming interface
 * @export
 */
export const UsersAPIKeysApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = UsersAPIKeysApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Revoke an API key for a specific user.
         ...
         * @throws {RequiredError}
         */
        async deleteAdminUserApikeysRevoke(userUuid: string, uuid: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteAdminUserApikeysRevoke(userUuid, uuid, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['UsersAPIKeysApi.deleteAdminUserApikeysRevoke']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getAdminUserApikeysList(userUuid: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiKeyList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAdminUserApikeysList(userUuid, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['UsersAPIKeysApi.getAdminUserApikeysList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async postAdminUserApikeysCreate(userUuid: string, apiKeyCreate: ApiKeyCreate, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiKey>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postAdminUserApikeysCreate(userUuid, apiKeyCreate, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['UsersAPIKeysApi.postAdminUserApikeysCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * UsersAPIKeysApi - factory interface
 * @export
 */
export const UsersAPIKeysApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = UsersAPIKeysApiFp(configuration)
    return {
        /**
         * 
         * @summary Revoke an API key for a specific user.
         ...
         * @throws {RequiredError}
         */
        deleteAdminUserApikeysRevoke(userUuid: string, uuid: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteAdminUserApikeysRevoke(userUuid, uuid, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get all API keys for a specific user.
         ...
         * @throws {RequiredError}
         */
        getAdminUserApikeysList(userUuid: string, options?: RawAxiosRequestConfig): AxiosPromise<ApiKeyList> {
            return localVarFp.getAdminUserApikeysList(userUuid, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Create a new API key for a specific user.
         ...
         * @throws {RequiredError}
         */
        postAdminUserApikeysCreate(userUuid: string, apiKeyCreate: ApiKeyCreate, options?: RawAxiosRequestConfig): AxiosPromise<ApiKey> {
            return localVarFp.postAdminUserApikeysCreate(userUuid, apiKeyCreate, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * UsersAPIKeysApi - object-oriented interface
 * @export
 * @class UsersAPIKeysApi
 * @extends {BaseAPI}
 */
export class UsersAPIKeysApi extends BaseAPI {
    /**
     * 
     * @summary Revoke an API key for a specific user.
     * @param {string} userUuid 
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof UsersAPIKeysApi
     */
    public deleteAdminUserApikeysRevoke(userUuid: string, uuid: string, options?: RawAxiosRequestConfig) {
        return UsersAPIKeysApiFp(this.configuration).deleteAdminUserApikeysRevoke(userUuid, uuid, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof UsersAPIKeysApi
     */
    public getAdminUserApikeysList(userUuid: string, options?: RawAxiosRequestConfig) {
        return UsersAPIKeysApiFp(this.configuration).getAdminUserApikeysList(userUuid, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof UsersAPIKeysApi
     */
    public postAdminUserApikeysCreate(userUuid: string, apiKeyCreate: ApiKeyCreate, options?: RawAxiosRequestConfig) {
        return UsersAPIKeysApiFp(this.configuration).postAdminUserApikeysCreate(userUuid, apiKeyCreate, options).then((request) => request(this.axios, this.basePath));
    }
}
