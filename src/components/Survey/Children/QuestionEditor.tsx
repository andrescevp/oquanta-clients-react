 ...
 */
const QuestionEditor: React.FC<QuestionEditorProps> = ({ surveyUuid, selectedQuestion, selectedQuestionFormKey }) => {
    ...
    if (!selectedQuestion) {
        return (
            <div className='h-full flex flex-col items-center justify-center p-8 text-gray-500 dark:text-gray-400 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800'>
                ...
                <p className='text-lg font-medium text-center'>{t('Select a question to edit')}</p>
                ...
                return (
                    <div className='p-4 bg-white/60 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm'>
                        <p className='text-gray-700 dark:text-gray-300'>
                            {t('Editor not implemented for this question type:')}
                        </p>
                ...
                return (
                    <div className='p-6 bg-white/60 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm'>
                        <p className='font-medium mb-2 text-gray-900 dark:text-white'>
                            {selectedQuestion.label || t('Question text')}
                        </p>
                    ...
                    <div className='p-6 bg-white/60 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm'>
                        ...
                        <div className='space-y-2'>
                            <div className='flex items-center'>
                                <input type='radio' disabled className='w-4 h-4 text-pumpkin-orange' />
                        ...
                        <div className='flex items-center justify-between mb-4'>
                            <div>
                                <h3 className='font-medium text-gray-900 dark:text-white'>
                                    {selectedQuestion.label || t('Block title')}
                                </h3>
                                {selectedQuestion.help && (
    ...
    return (
        <div className='h-full flex flex-col'>
            <div className='p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-900'>
                ...
                <p className='text-xs text-gray-500 dark:text-gray-500 mt-1 font-mono'>{selectedQuestionFormKey}</p>
            </div>
