 ...
 */
const QuestionLoopConceptsEditor: React.FC<QuestionLoopConceptsEditorProps> = ({ questionCode, formPath }) => {
            ...
            <div className='bg-white/60 dark:bg-gray-800/50 backdrop-blur-sm p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm'>
                ...
                <div className='mb-3'>
                    <p className='text-sm text-gray-600 dark:text-gray-400'>
                        {t(
                            'Define concepts that will be used in the loop iterations. Each concept represents an iteration variable.',
                        )}
                    </p>
                </div>
