...
const QuestionRowsColumnsEditor: React.FC<QuestionRowsColumnsEditorProps> = ({
    ...
    return (
        <div className="space-y-6">
            {/* Choices Section */}
            {isChoiceQuestion && (useRowsAsChoices || useColumnsAsChoices) && <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                    {t('Choices are automatically generated from rows or columns.')}
                </p>
            </div>}
            {(!useRowsAsChoices && !useColumnsAsChoices) && <div
                className="bg-white/60 dark:bg-gray-800/50 backdrop-blur-sm p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                {choices && choices.length > 0 ? (
                                ...
                                <div className="flex-grow grid grid-cols-1 md:grid-cols-2 gap-3">
                                    ...
                                    <InputWithLabel
                                        ...
                                        inputProps={{
                                            ...
                                            onChange: (e) => handleUpdateChoice(index, 'value', parseInt(e.target.value, 10)),
                                            className: 'backdrop-blur-sm',
                                        }}
                                    />
                                </div>
                    ...
                    <div
                        className="text-center py-4 text-gray-500 dark:text-gray-400 text-sm border border-dashed border-gray-300 dark:border-gray-600 rounded-lg">
            ...
            <div
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2 justify-end">
                        {isChoiceQuestion && !useColumnsAsChoices && <div className="flex items-center flex-col w-1/3">
                                        ...
                                        <input
                                            ...
                                            {...register(`${formPath}.options.useRowsAsChoices` as any, {
                                                ...
                                                onChange: (e) => {
                                                    ...
                                                    setValue(`${formPath}.options.useRowsAsChoices` as any, updatedValue, {
                                                        shouldValidate: true,
                                                        shouldDirty: true,
                                                    });
                                                    if (updatedValue) {
                                                        setValue(`${formPath}.options.useColumnsAsChoices` as any, false, {
                                                            shouldValidate: true,
                                                            shouldDirty: true,
                                                        });
                                                    }
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                                {t('Respondent can select one or more rows as choices. Current choices will be overridden.')}
                            </p>
                        </div>}
                        <button
                            type="button"
            ...
            <div
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2 justify-end">
                        {isChoiceQuestion && !useRowsAsChoices && <div className="flex items-center flex-col w-1/3">
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                                        {t('Use rows as choices')}
                                    ...
                                    <label className="relative inline-flex items-center cursor-pointer">
                                        <input
                                            ...
                                            {...register(`${formPath}.options.useColumnsAsChoices` as any, {
                                                ...
                                                onChange: (e) => {
                                                    const updatedValue = e.target.checked;
                                                    setValue(`${formPath}.options.useColumnsAsChoices` as any, updatedValue, {
                                                        shouldValidate: true,
                                                        shouldDirty: true,
                                                    });
                                                    if (updatedValue) {
                                                        setValue(`${formPath}.options.useRowsAsChoices` as any, false, {
                                                            shouldValidate: true,
                                                            shouldDirty: true,
                                                        });
                                                    }
