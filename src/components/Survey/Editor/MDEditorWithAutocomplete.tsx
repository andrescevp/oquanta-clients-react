...
const TooltipMarker: React.FC<React.PropsWithChildren> = ({
                                                              children,
                                                          }) => {
...
const MDEditorWithAutocomplete: React.FC<MDEditorWithAutocompleteProps> = ({
    ...
    return (
        <div id={`editor-${editorKey}`} className={cn(
            'w-full',
            error ? 'has-error' : '',
        )}>
            <MDEditor
                ...
                className={cn(
                    ...
                    error ? 'border-red-500 focus-within:ring-2 focus-within:ring-red-500/50' : 'focus-within:border-pumpkin-orange focus-within:ring-2 focus-within:ring-pumpkin-orange/50',
                    className,
                )}
                textareaProps={{
                    placeholder,
