            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="space-y-1">
                <InputWithLabel
                  ...
                  helperText={t('Respondents must select exactly this number of options. If set, min/max settings are ignored.')}
                  inputProps={{
                    type: "number",
                    min: 0,
                ...
                {options?.fixedChoices !== undefined && options.fixedChoices > 0 && (
                  <div className="flex items-center text-amber-600 dark:text-amber-400 mt-1">
                    ...
                    <p className="text-xs">{t('Using fixed choices will override min/max settings')}</p>
                  </div>
                )}
              </div>
              ...
              {options?.minChoices !== undefined && options?.maxChoices !== undefined && 
               options.minChoices > options.maxChoices && options.maxChoices > 0 && (
                <div className="flex items-center text-red-600 dark:text-red-400">
                  <AlertCircleIcon className="h-4 w-4 mr-1.5" />
                  <p className="text-xs">{t('Minimum choices cannot be greater than maximum choices')}</p>
                </div>
              )}
            </div>
          </div>
