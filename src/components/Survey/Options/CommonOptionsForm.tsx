        ...
        <div className={cn('space-y-5', className)}>
            ...
            <div className='flex items-center justify-between'>
                <div className='space-y-0.5'>
                    <label className='text-sm font-medium text-gray-700 dark:text-gray-300'>{t('Required')}</label>
            ...
            <div className='flex items-center justify-between'>
                <div className='space-y-0.5'>
                    <label className='text-sm font-medium text-gray-700 dark:text-gray-300'>{t('Hidden')}</label>
                    <p className='text-xs text-gray-500 dark:text-gray-400'>
            ...
            {showRandomize && (
                <div className='space-y-4 pt-2 border-t border-gray-200 dark:border-gray-700'>
                    <div className='flex items-start'>
                        ...
                        <p className='text-sm text-gray-600 dark:text-gray-400'>{t('Matrix randomization options')}</p>
                    </div>
