...
const QuestionTree: React.FC<QuestionTreeProps> = ({
    ...
    const addNewQuestion = () => {
        ...
        const formPath = generateFormPath(newQuestion);
        console.log('Form path for new question:', formPath);
        onItemSelect(newQuestion, formPath);
    };
    ...
    const addNewBlock = () => {
        ...
        onItemsChange(newItems);
        const formPath = generateFormPath(newBlock);
        onItemSelect(newBlock, formPath);
    };
    ...
    const addNewLoop = () => {
        ...
        onItemsChange(newItems);
        const formPath = generateFormPath(newLoop);
        onItemSelect(newLoop, formPath);
    };
    ...
    return (
        <div className="h-full flex flex-col">
            <div
                className="p-2 space-y-2 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
                ...
                >
                    ...
                    >
                        <div className={rootContainerClasses} id="root-container">
                            {items.length > 0 ? (
                                ...
                                <div
                                    className="text-center py-12 text-gray-500 dark:text-gray-400 flex flex-col items-center">
                                    <div
                                        className="w-16 h-16 mb-4 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center">
                    ...
                    <DragOverlay>
                        {activeItemRef.current ? (
                            <div
                                className="opacity-90 bg-gradient-to-r from-white/90 to-white/70 dark:from-gray-800/90 dark:to-gray-800/70 p-3 rounded-xl border border-gray-200 dark:border-gray-700 shadow-xl backdrop-blur-sm">
