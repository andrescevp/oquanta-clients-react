...
const SortableItem: React.FC<SortableItemProps> = ({
    ...
    return (
        <div
            ref={setRefs}
            style={style}
            className={clsx('flex items-center space-x-2 p-2 mb-1 rounded border transition-colors', {
            ...
            <div className='flex-1 cursor-pointer truncate space-y-1' onClick={onClick}>
                ...
                <div className='flex items-center text-xs text-gray-500 dark:text-gray-400 space-x-2'>
                    ...
                    <span>{item.type}</span>
                    <div className='font-medium text-sm shadow px-2 border-gray-200 bg-blue-200 w-auto rounded text-ellipsis overflow-hidden'>
                        {item.code || id}
                    </div>
                </div>
            </div>
