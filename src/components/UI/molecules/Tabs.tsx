...
export const Tabs = React.forwardRef<React.ElementRef<typeof Tab.Group>, TabsProps>(({ className, ...props }, ref) => (
    <Tab.Group ref={ref} {...props} className={cn('w-full', className)} />
));
...
export const TabsList = React.forwardRef<React.ElementRef<typeof Tab.List>, TabsListProps>(
    ({ className, ...props }, ref) => (
        <Tab.List
            ref={ref}
            className={cn('flex h-10 items-center rounded-md bg-gray-100 p-1 dark:bg-dark-800', className)}
            {...props}
        />
    ),
);
...
export const TabsTrigger = React.forwardRef<React.ElementRef<typeof Tab>, TabsTriggerProps>(
...
export const TabsContent = React.forwardRef<React.ElementRef<typeof Tab.Panel>, TabsContentProps>(
    ({ className, ...props }, ref) => (
        <Tab.Panel
            ref={ref}
            className={cn(
