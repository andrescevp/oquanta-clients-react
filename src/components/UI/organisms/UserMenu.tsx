...
export const UserMenu: React.FC = () => {
    ...
    const getItem = (item: UserMenuItem) => ({ active }: {active: boolean}) => {
        ...
        const className = cn(
            ...
            active ? "bg-gray-100/80 dark:bg-gray-700/50" : ""
        );
        ...
        return item.href ? (
            ...
            <button
                onClick={item.onClick || (item.isThemeToggle ? toggleTheme : undefined)}
                className={className}
            >
                {ItemContent}
            </button>
