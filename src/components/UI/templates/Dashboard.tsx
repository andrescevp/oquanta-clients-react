...
export const Dashboard: React.FC<DashboardLayoutProps> = ({ children }) => {
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 overflow-hidden backdrop-blur-sm'>
            {/* Decorative elements */}
            <div
                className='fixed top-20 left-20 w-64 h-64 bg-pumpkin-orange/5 rounded-full blur-3xl'
                aria-hidden='true'
            />
            <div
                className='fixed bottom-20 right-20 w-64 h-64 bg-iris-purple/5 rounded-full blur-3xl'
                aria-hidden='true'
            />
            <div
                className='fixed top-1/2 left-1/3 w-96 h-96 bg-lime-green/5 rounded-full blur-3xl'
                aria-hidden='true'
            />
            ...
            <div
                ...
                <main className='h-[calc(100vh-4rem)] overflow-auto p-4 lg:p-6 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent'>
                    <div className='relative max-w-[2000px] mx-auto'>{children}</div>
                </main>
            </div>
        </div>
    );
