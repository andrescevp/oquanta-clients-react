...
import {
    Organization,
    OrganizationPlace,
    OrganizationPlaceCreate,
    OrganizationPlacesApi,
    OrganizationPlaceUpdate,
    OrganizationsApi,
        ...
        return () => {
            ...
            if (mapInstanceRef.current) {
                try {
                    ...
                    // Renombrar 'error' a 'mapError' para evitar shadow
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div className='space-y-6'>
                        {/* Organización */}
                        <div>
                            <label className='block text-sm font-medium text-gray-700 mb-2'>{t('Organización')}</label>
                            <Controller
                    ...
                    <div className='space-y-6'>
                        ...
                        <InputWithLabel
                            ...
                            error={
                                errors.postalCode && t(errors.postalCode.message || 'El código postal es obligatorio')
                            }
                            inputProps={{
                                type: 'text',
                ...
                <div className='flex justify-between items-center mt-8'>
                    ...
                    <div className='flex justify-end space-x-2 flex-grow'>
                        ...
                        <ButtonLoader
                            ...
                            {organizationPlaceData?.uuid ? t('Actualizar') : t('Crear')}
                        </ButtonLoader>
                    </div>
                </div>
            </form>
