...
export const OrganizationPlaceSurveys: React.FC<OrganizationPlaceSurveysProps> = ({
    ...
    const columns = [
        ...
        {
            name: t('Tipo'),
            selector: (row: OrganizationPlaceSurvey) => (row.surveyType === 'tracker' ? t('Tracker') : t('Campaña')),
            sortable: true,
        },
        {
            name: t('Estado'),
        ...
        {
            name: t('Fecha fin'),
            selector: (row: OrganizationPlaceSurvey) => (row.endAt ? format(new Date(row.endAt), 'dd/MM/yyyy') : '-'),
            sortable: true,
        },
        {
            name: t('Acciones'),
    ...
    return (
        <div className='w-full'>
            <div className='flex justify-between mb-4'>
                <h2 className='text-xl font-semibold text-gray-800 dark:text-gray-200'>{t('Encuestas del lugar')}</h2>
                ...
                <OffsetPanel
                    ...
                    defaultOpen={false}
                    onOpen={() => handlePanelOpen()}>
                    <OrganizationPlaceSurveyForm mode='create' onSubmit={onSubmit} isSubmitting={isSubmitting} />
                </OffsetPanel>
            </div>
