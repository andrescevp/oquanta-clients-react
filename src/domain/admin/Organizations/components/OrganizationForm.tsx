...
const OrganizationForm: React.FC<OrganizationFormProps> = ({ uuid, organizationData, onSuccess, onCancel }) => {
    ...
    const roleOptions: RoleOption[] = [{ value: 'ROLE_OWNER', label: t('Owner') }];
    ...
    return (
        <div className='p-6 space-y-6 max-w-7xl'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <InputWithLabel
                        ...
                        error={
                            errors.contactEmail &&
                            t(errors.contactEmail.message || 'El email no tiene un formato válido')
                        }
                        inputProps={{
                            type: 'email',
                    ...
                    <InputWithLabel
                        ...
                        error={
                            ...
                            t(errors.mainContactPhone.message || 'Formato de teléfono inválido')
                        }
                        inputProps={{
                            type: 'tel',
                    ...
                    <InputWithLabel
                        ...
                        error={
                            ...
                            t(errors.secondaryContactPhone.message || 'Formato de teléfono inválido')
                        }
                        inputProps={{
                            type: 'tel',
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex justify-end space-x-2 flex-grow'>
                        ...
                        <ButtonLoader
                            ...
                            {organizationData?.uuid ? t('Actualizar') : t('Crear')}
                        </ButtonLoader>
                    </div>
                </div>
            </form>
            ...
            {organizationData?.uuid && <OrganizationUsersTable organizationData={organizationData} />}
        </div>
    );
};
