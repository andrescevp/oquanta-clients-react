    ...
    return (
        <div className='h-screen w-full relative overflow-hidden'>
            ...
            <div className='absolute top-4 right-4 z-50'>
                <Link
                    to='/login'
                    className='bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md shadow-md transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50'>
                    {t('Login')}
                </Link>
            </div>
                        ...
                        <ul className='py-2'>
                            {searchResults.map(result => (
                                <li
                                    ...
                                    {result.address && <div className='text-sm text-gray-500'>{result.address}</div>}
                                </li>
                            ))}
                        </ul>
                    </div>
