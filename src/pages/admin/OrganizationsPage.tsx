...
import {
    GetApiOrganizationsListOrderEnum,
    Organization,
    OrganizationBasic,
    OrganizationList,
    OrganizationsApi,
    ...
    const handleSort = (column: TableColumn<OrganizationBasic>, sortDirection: string) => {
        ...
        setSortOrder(
            sortDirection.toUpperCase() === 'DESC'
                ? GetApiOrganizationsListOrderEnum.Desc
                : GetApiOrganizationsListOrderEnum.Asc,
        );
    };
    ...
    return (
        <div className='container mx-auto px-4 py-8'>
            ...
            <div className='mb-4 flex justify-end items-center space-x-1'>
                ...
                <button className='btn' onClick={loadOrganizations} title={t('Actualizar')}>
                    <IconRefresh size={20} />
                </button>
            </div>
            ...
            <div className='rounded-t shadow-md'>
                <DataTable<OrganizationBasic>
                    ...
                    noDataComponent={
                        <div className='p-4 text-center text-gray-500'>{t('No hay organizaciones disponibles')}</div>
                    }
                />
            </div>
        </div>
