    ...
    return (
        <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 px-6 py-12'>
            <div className='w-full max-w-md relative'>
                ...
                />
                <div
                    className='absolute -bottom-10 -right-10 w-32 h-32 bg-iris-purple/10 rounded-full blur-3xl'
                    aria-hidden='true'
                />
                            ...
                            <form className='space-y-6' onSubmit={handleSubmit(onSubmit)} noValidate>
                                ...
                                <div className='bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl border border-gray-200 dark:border-gray-600'>
                                    <p className='text-gray-700 dark:text-gray-300'>
                                        {t('Welcome')}{' '}
                                        {userEmail ? (
                                            <span className='font-medium text-iris-purple dark:text-iris-purple/90'>
                                                {userEmail}
                                            </span>
                                        ) : (
                                            ''
                                        )}
                                        ! {t('Please set your password to complete your registration.')}
                                    </p>
                                </div>
