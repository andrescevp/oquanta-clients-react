...
import { PasswordResetApi, ResetPassword as ResetPasswordType,TokenValidation } from '../../api-generated/api';
// Import your logo
...
export const ResetPasswordPage: React.FC = () => {
  ...
  useEffect(() => {
    const validateToken = async () => {
      ...
      try {
        ...
        const response = await api.postApiValidateResetToken(tokenValidation);
        
        if (response.data.valid) {
          setTokenValid(true);
        } else {
          setError(t('This password reset link is no longer valid. It may have expired or been used already.'));
        }
      } catch (err) {
        setError(t('Unable to validate reset token. The link may be invalid or expired.'));
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      await api.postApiResetPassword(resetData);
      setSuccess(true);
      ...
      setError(t('Failed to reset password. Please try again or request a new reset link.'));
          ...
          <div className="relative z-10">
            ...
            {validatingToken && (
              <div className="flex flex-col items-center justify-center py-4">
                <div className="w-12 h-12 rounded-full border-4 border-pumpkin-orange/30 border-t-pumpkin-orange animate-spin mb-4"></div>
                <p className="text-gray-600 dark:text-gray-300">{t('Verifying your reset link...')}</p>
              </div>
            )}
            ...
            {success && (
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  {t('Your password has been successfully reset. You will be redirected to the login page.')}
                </p>
